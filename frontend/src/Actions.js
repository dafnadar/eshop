...
const CLEAR_CART = 'REMOVE_FROM_CART';
...
export { GET_SUCCESS, GET_FAIL, GET_REQUEST, ADD_TO_CART, REMOVE_FROM_CART, USER_SIGNIN, USER_SIGNOUT, SAVE_SHIPPING_ADDRESS, SAVE_PAYMENT_METHOD, CLEAR_CART };